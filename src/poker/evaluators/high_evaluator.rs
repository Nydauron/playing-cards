...
///
/// A vector is returned rather than a single element in the event of side pots (e.g. best hand
/// only wins the main pot, 2nd best hand wins the side pot). The HashSet serves as to who had
/// identical hands.
