...
pub fn evaluate_hand(player_hand: &Vec<Card>, board: &Vec<Card>) -> Result<DramahaHighRank, EvaluatorError> {
    ...
    Ok(DramahaHighRank { omaha_rank: omaha_hand_rank, draw_rank: draw_hand_rank })
}
